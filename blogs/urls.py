...
urlpatterns = patterns('',
	...
	url(r'^categories/(?P<pk_category>\d+)/remove/$', views.delete_category_view, name='delete_category'),
	url(r'^categories/(?P<pk_category>\d+)/rename/$', views.rename_category_view, name='rename_category'),
